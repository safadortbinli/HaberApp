...
export default class App extends React.Component {
  ...
  async getPost() {
    let veri = await fetch(
      "http://newsapi.org/v2/top-headlines?country=tr&apiKey=819954f41ce748aba629e959b7707bec"
    );
    ...
    return (
      <View>
        <Header
          ...
          centerComponent={{
            text: "HABERLER",
            style: { color: "#fff", fontWeight: "bold", fontSize: 17, top: 3 },
          }}
          rightComponent={
            <TouchableOpacity onPress={() => this.getPost()}>
        ...
        <ScrollView>
          <View>
                ...
                <TouchableOpacity onPress={() => Linking.openURL(item.url)}>
                  ...
                  >
                    ...
                    >
                      ...
                      <View
                        style={{ flexDirection: "column", width: wp("69%") }}
                      >
                        ...
                        >
                          <Text style={{ fontSize: 10, marginRight: wp("3%") }}>
                            {item.source.name}
                          </Text>
                        </View>
                      </View>
                    ...
                    <View>
                      <Divider
                        style={{ backgroundColor: "black", width: wp("100%") }}
                      />
                    </View>
                  </View>
                </TouchableOpacity>
            ...
            />
            <View
              style={{ height: hp("10%"), justifyContent: "flex-end" }}
            ></View>
          </View>
        </ScrollView>
      </View>
